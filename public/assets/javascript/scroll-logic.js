...
sr.reveal('.project-card', { duration: 1800, origin: 'bottom', distance: '80px', easing: 'ease-in-out', delay: 300 });
...
sr.reveal('.writing-type', { duration: 1800, origin: 'bottom', distance: '80px', easing: 'ease-in-out', delay: 300 });